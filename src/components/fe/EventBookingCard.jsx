    ...
    <Box p={4} borderWidth="1px" borderRadius="md" mb={4} boxShadow="md">
      <SimpleGrid columns={{ base: 1, md: 4 }} spacing={4} gap={5}>
        ...
        <VStack align="start" spacing={2} gridColumn={{ base: 'span 1', md: 'span 3' }} height="100%">
          ...
          <Text fontSize="sm" display="flex" alignItems="center"> <BsCalendarDate style={{ marginRight: "5px" }} /> {booking.eventStartDate}</Text>
          <Text fontSize="sm" display="flex" alignItems="center"> <IoMdTime style={{ marginRight: "5px" }} /> {booking.eventStartDate} - {booking.eventEndDate}</Text>
